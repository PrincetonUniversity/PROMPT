...
class DependenceWithContextModule : public LocalWriteModule {
private:
...
public:
  DependenceWithContextModule(uint32_t mask, uint32_t pattern)
  ...
  ~DependenceWithContextModule() override { delete smmap; }

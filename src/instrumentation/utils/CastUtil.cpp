...
Value *liberty::castToInt64Ty(Value *value, InstInsertPt &out,
                              NewInstructions *ni) {
...
Value *liberty::castIntToInt32Ty(Value *value, InstInsertPt &where,
                                 NewInstructions *ni) {
...
Value *liberty::castPtrToVoidPtr(Value *ptr, InstInsertPt &where,
                                 NewInstructions *ni) {
...
Value *liberty::castFromInt64Ty(Type *ty, Value *value, InstInsertPt &out,
                                NewInstructions *ni) {
